...
if (sceneNameElement) {
 ...
 // Cria o elemento principal do hotspot de informação
  var wrapper = document.createElement('div');
  wrapper.classList.add('hotspot');
  ...
  title.innerHTML = hotspot.title || ''; // título do balão
  titleWrapper.appendChild(title);

  header.appendChild(iconWrapper);
  header.appendChild(titleWrapper);

  // Texto do corpo do balão
  var textWrapper = document.createElement('div');
  textWrapper.classList.add('info-hotspot-text');
  textWrapper.innerHTML = hotspot.text || ''; // conteúdo principal

  // Monta o balão completo
  wrapper.appendChild(header);
  wrapper.appendChild(textWrapper);

  // Permite abrir/fechar o balão ao clicar
  header.addEventListener('click', function () {
    wrapper.classList.toggle('visible');
  });

  // Evita interferência no movimento da câmera
  stopTouchAndScrollEventPropagation(wrapper);
